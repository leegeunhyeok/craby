...
import { NativeModuleRegistry, type NativeModule } from 'craby-modules';
...
Ready to get started? Head over to the [Create a Project](/docs/get-started/create-project) guide to create your first Craby module!
