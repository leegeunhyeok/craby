package com.calculatorcpp

import com.facebook.react.bridge.ReactApplicationContext
import com.facebook.react.module.annotations.ReactModule

@ReactModule(name = CalculatorModule.NAME)
class CalculatorCppModule(reactContext: ReactApplicationContext) :
  NativeCalculatorCppSpec(reactContext) {

  init {
    System.loadLibrary("crabycalculatorcpp")
  }
